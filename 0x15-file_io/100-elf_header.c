...
/**
 * check_elf - functions that hecks if a file is an ELF file.
 * @e_ident: A pointer to an array containing the ELF magic numbers.
 *
 * Description: exit code 98 if the file is not an ELF file - exit code 98.
 */
void check_elf(unsigned char *e_ident)
{
int index;
...
/**
 * print_abi - functions prints the ABI version of an ELF header.
